...
(cl:defmethod k-val ((m <remote_control_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nav_core-msg:k-val is deprecated.  Use nav_core-msg:k instead.")
  (k m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <remote_control_msg>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'k)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 65536) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    )
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <remote_control_msg>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'k) (cl:if (cl:< unsigned 32768) unsigned (cl:- unsigned 65536))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<remote_control_msg>)))
  ...
  "c7ddfb995000097a6c5a0e1e0dd114c0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'remote_control_msg)))
  "Returns md5sum for a message object of type 'remote_control_msg"
  "c7ddfb995000097a6c5a0e1e0dd114c0")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<remote_control_msg>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%int16 ch_1~%int16 ch_2~%int16 k~%int16 key_value~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'remote_control_msg)))
  "Returns full string definition for message of type 'remote_control_msg"
  (cl:format cl:nil "std_msgs/Header header~%int16 ch_1~%int16 ch_2~%int16 k~%int16 key_value~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
