...
class remote_control_msg {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('ch_1')) {
        this.ch_1 = initObj.ch_1
      }
      else {
        this.ch_1 = 0;
      }
      if (initObj.hasOwnProperty('ch_2')) {
        this.ch_2 = initObj.ch_2
      }
      else {
        this.ch_2 = 0;
      }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [ch_1]
  ...
  static Resolve(msg) {
    ...
    if (msg.ch_1 !== undefined) {
      resolved.ch_1 = msg.ch_1;
    }
    else {
      resolved.ch_1 = 0
    }

    if (msg.ch_2 !== undefined) {
      resolved.ch_2 = msg.ch_2;
    }
    else {
      resolved.ch_2 = 0
    }
